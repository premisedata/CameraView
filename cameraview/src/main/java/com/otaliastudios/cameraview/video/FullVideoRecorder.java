...
public abstract class FullVideoRecorder extends VideoRecorder {
    ...
    private boolean prepareMediaRecorder(@NonNull VideoResult.Stub stub,
        ...
        if (stub.videoFrameRate <= 0) stub.videoFrameRate = 15; //mProfile.videoFrameRate
        ...
        if (applyEncodersConstraints) {
            ...
            while (!encodersFound) {
                ...
                try {
                    ...
                    newVideoFrameRate = 15; //encoders.getSupportedVideoFrameRate(newVideoSize,stub.videoFrameRate)
